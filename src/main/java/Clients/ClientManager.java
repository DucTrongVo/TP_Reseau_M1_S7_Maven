...
/**
 * Classe qui représente un client Manager inhéritant d'un Client TCP
 */
public class ClientManager {

  public static void main(String args[]) throws Exception{
    // Création d'un socket client et connexion avec un serveur fonctionnant sur la même machine et sur le port 28415
    ...
    while(!chaine.equalsIgnoreCase("FIN")) {
      ...
      System.out.println("Chaine reçue est : "+chaine);
    }
